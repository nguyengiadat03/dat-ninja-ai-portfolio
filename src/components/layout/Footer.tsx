      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Lập trình viên FrontEnd chuyên nghiệp, kết hợp nghệ thuật và công nghệ 
              để tạo nên những sản phẩm web mang dấu ấn riêng.
            </p>
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                <Mail className="w-4 h-4" />
                <span>dat.nguyen@example.com</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          {/* Legal & Social */}
          <div>
            <h3 className="font-semibold text-foreground mb-4">Pháp lý & Mạng xã hội</h3>
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2024 Nguyễn Gia Đạt. Tất cả quyền được bảo lưu.
          </p>
