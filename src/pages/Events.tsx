  ...
  const events = [
    {
      ...
      image:
        "https://yoxkoxpwgiwskdnjjhyd.supabase.co/storage/v1/object/sign/sukien/letanai.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYzBlZDFkZS00MzRjLTQ3NWMtOWQ1ZC02ZmYxNTY2ZDNiOTQiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJzdWtpZW4vbGV0YW5haS5qcGciLCJpYXQiOjE3NTU2NzE4NTYsImV4cCI6MTc4NzIwNzg1Nn0.m7W9T7rXIbYl3Us75lxsXFGi3FkD9NC_-oX2VG3tG34",
    ...
    },
    {
      ...
      image:
        "https://yoxkoxpwgiwskdnjjhyd.supabase.co/storage/v1/object/sign/sukien/sukien3.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYzBlZDFkZS00MzRjLTQ3NWMtOWQ1ZC02ZmYxNTY2ZDNiOTQiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJzdWtpZW4vc3VraWVuMy5qcGciLCJpYXQiOjE3NTU1MDU3MTcsImV4cCI6MTc4NzA0MTcxN30.fJ7LrhVY_yBKuLFIXQ4uETjpZ8VUZZFwMtZO672K4pw",
    ...
    },
    {
      ...
      image:
        "https://yoxkoxpwgiwskdnjjhyd.supabase.co/storage/v1/object/sign/sukien/tintuc1.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYzBlZDFkZS00MzRjLTQ3NWMtOWQ1ZC02ZmYxNTY2ZDNiOTQiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJzdWtpZW4vdGludHVjMS5qcGciLCJpYXQiOjE3NTU1MDU3NDksImV4cCI6MTc4NzA0MTc0OX0.tBiZ22QjgIPGOhl-GV-Qsv7RxVIEKBjK9Ug4T_bOAfo",
  ...
  return (
    <>
      <SEO
        ...
        description="Tham gia các sự kiện công nghệ, workshop và meetup để cùng học hỏi, chia sẻ kinh nghiệm và kết nối với cộng đồng developer Việt Nam."
        keywords="sự kiện công nghệ, workshop, meetup, AI, machine learning, frontend, backend"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 max-w-3xl mx-auto font-bold italic">
              Tham gia các sự kiện công nghệ, workshop và meetup để cùng học
              hỏi, chia sẻ kinh nghiệm và kết nối với cộng đồng developer Việt
              Nam.
            </p>
          </div>
                  ...
                  <div className="lg:col-span-2 p-6">
                    ...
                    {event.status === "upcoming" && (
                      <Button
                        ...
                        onClick={() => {
                          navigate("/chuong-trinh/ninja-ai", {
          ...
          <div className="text-center mt-16">
            <Card className="p-8 bg-gradient-hero border-none">
              ...
              <p className="text-muted-foreground mb-6">
                Tôi luôn sẵn sàng chia sẻ kiến thức và kinh nghiệm tại các sự
                kiện công nghệ
              </p>
              <Button
