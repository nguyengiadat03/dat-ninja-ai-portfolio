...
const News = () => {
  ...
  return (
    <>
      <SEO
        title="Tin tức & Blog"
        description="Những bài viết, tutorial và chia sẻ kinh nghiệm về công nghệ, lập trình và phát triển sự nghiệp trong ngành IT."
        keywords="blog, tin tức, công nghệ, lập trình, AI, frontend, backend, tutorial"
      />
          ...
          <div className="mt-16">
            <Card className="p-8 bg-gradient-hero border-none text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Nhận những bài viết mới nhất về công nghệ, tutorial và kinh
                nghiệm phát triển sự nghiệp trong ngành IT ngay trong email của
                bạn.
              </p>
