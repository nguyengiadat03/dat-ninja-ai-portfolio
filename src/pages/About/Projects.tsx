  ...
  const projects = [
    {
      ...
      description: "Nền tảng thương mại điện tử hoàn chỉnh với tính năng thanh toán trực tuyến, quản lý sản phẩm và hệ thống đánh giá người dùng.",
    ...
    },
    {
      ...
      description: "Chatbot AI hỗ trợ tư vấn y tế cơ bản, tích hợp với hệ thống bệnh viện và có khả năng học hỏi từ dữ liệu bệnh nhân.",
      image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=500&h=300&fit=crop",
      technologies: ["Python", "TensorFlow", "React", "OpenAI API", "PostgreSQL"],
      liveUrl: "#",
      githubUrl: "#",
      duration: "4 tháng",
      team: "3 người",
    ...
    },
    {
      ...
      description: "Hệ thống quản lý học tập trực tuyến với tính năng video streaming, bài kiểm tra tự động và theo dõi tiến độ học tập.",
    ...
    },
    {
      ...
      description: "Dashboard điều khiển và giám sát các thiết bị IoT trong nhà thông minh, với tính năng tự động hóa và báo cáo năng lượng.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Tổng hợp những dự án đặc sắc mà tôi đã tham gia phát triển, từ ứng dụng web 
            đến các giải pháp AI và IoT. Mỗi dự án đều thể hiện sự sáng tạo và chuyên môn trong lĩnh vực công nghệ.
          </p>
        </div>
            ...
            >
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-0 ${index % 2 === 1 ? 'lg:grid-cols-2' : ''}`}>
                ...
                <div className="p-8 flex flex-col justify-center">
                  ...
                  {/* Technologies */}
                  <div className="mb-6">
                    <h4 className="font-semibold text-foreground mb-2">Công nghệ sử dụng:</h4>
        ...
        <div className="text-center mt-16">
          <Card className="p-8 bg-gradient-hero border-none">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Tôi luôn sẵn sàng thảo luận về những ý tưởng sáng tạo và cùng nhau biến chúng thành hiện thực. 
              Hãy liên hệ để chúng ta có thể hợp tác!
            </p>
            <Button 
              asChild 
              size="lg"
