  ...
  const roadmapItems = [
    {
      phase: "Tuần 1-2",
      title: "Foundations",
      description: "Làm quen với AI cơ bản, Python programming, và Git workflow",
      color: "bg-primary"
    },
    {
      phase: "Tuần 3-4", 
      title: "Machine Learning",
      description: "Học các thuật toán ML cơ bản, data preprocessing và model evaluation",
      color: "bg-accent"
    },
    {
      phase: "Tuần 5-6",
      title: "Deep Learning",
      description: "Neural networks, TensorFlow/PyTorch, và computer vision cơ bản",
      color: "bg-secondary-dark"
    },
    {
      phase: "Tuần 7-8",
      title: "NLP & Chatbots",
      description: "Natural Language Processing, OpenAI API, và xây dựng chatbot",
      color: "bg-success"
    },
    {
      phase: "Tuần 9-10",
      title: "Web Integration",
      description: "Tích hợp AI vào ứng dụng web, API development, và deployment",
      color: "bg-warning"
    },
    {
      phase: "Tuần 11-12",
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Chương trình <span className="text-gradient-primary">Thực tập sinh</span><br />
              <span className="text-gradient-primary">Ninja AI</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Trở thành những ninja công nghệ AI của tương lai. Chương trình đào tạo chuyên sâu 
              12 tuần với mentor kinh nghiệm và dự án thực tế.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-white text-white hover:bg-white hover:text-black btn-scale px-8 py-4 text-lg"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Chương trình được thiết kế để đào tạo những ninja AI với kỹ năng thực tế và tư duy sáng tạo
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Mục tiêu",
                content: "Đào tạo những lập trình viên AI có khả năng phát triển và triển khai các giải pháp AI trong thực tế"
              },
              {
                icon: <BookOpen className="w-8 h-8" />,
                title: "Phương pháp",
                content: "Học tập theo dự án (Project-based Learning) với sự hướng dẫn 1:1 từ mentor kinh nghiệm"
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "Đối tượng", 
                content: "Sinh viên, fresh graduate hoặc người chuyển ngành có đam mê với AI và công nghệ"
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: "Đầu ra",
                content: "Chứng chỉ Ninja AI, portfolio dự án thực tế và cơ hội việc làm tại các công ty đối tác"
              }
            ].map((item, index) => (
              <Card key={index} className="p-6 text-center card-hover-green bg-gradient-card border-none">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Chương trình 12 tuần được chia thành 6 giai đoạn, mỗi giai đoạn có mục tiêu và kết quả cụ thể
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => (
              <Card key={index} className="p-8 card-hover-pink bg-gradient-card border-none">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Điền thông tin để trở thành một thành viên của đại gia đình Ninja AI
            </p>
          </div>
          ...
          <Card className="p-8 bg-gradient-card border-none shadow-lg">
            ...
            <div className="mt-8 p-4 bg-secondary/10 rounded-lg">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Chúng tôi sẽ liên hệ với bạn trong vòng 48 giờ sau khi nhận được đơn ứng tuyển</span>
              </div>
            </div>
          </Card>
        </div>
